...
if __name__ == "__main__":
    ...
    print(
        f"Valid expressions: {results['valid_expressions'][0]}/{results['valid_expressions'][1]}"
    )
    print(
        f"Core functions: {results['core_functions'][0]}/{results['core_functions'][1]}"
    )
    print(
        f"Invalid detection: {results['invalid_detected'][0]}/{results['invalid_detected'][1]}"
    )
