...
from vector_vrl._bindings import execute_vrl, get_vrl_performance, validate_vrl
...
def test_basic_execution():
    ...
    for result in results:
        assert result["level"].isupper(), (
            f"Level should be uppercase: {result['level']}"
        )
...
def test_error_handling():
    ...
    print("Infallible operations work correctly")
