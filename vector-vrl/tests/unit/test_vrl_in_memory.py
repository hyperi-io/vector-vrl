...
try:
    from vector_vrl._bindings import (
        execute_vrl,
        get_vrl_performance,
        validate_vrl,
    )
    ...
    print(f"VRL bindings not available: {e}")
...
class TestVRLInMemory(unittest.TestCase):
    ...
    def test_error_handling_in_memory(self):
        ...
        for result in results:
            ...
            self.assertTrue(
                "error_handling" in result or "error" in result or "level" in result
            )
    ...
    def test_data_enrichment_in_memory(self):
        ...
        for result in results:
            ...
            self.assertTrue(
                "enrichment" in result
                or "processed_at" in result
    ...
    def test_complex_routing_in_memory(self):
        ...
        for result in results:
            self.assertTrue(
                "level" in result or "route" in result or "service" in result
            )
