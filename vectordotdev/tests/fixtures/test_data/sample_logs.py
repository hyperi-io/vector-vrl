...
class LogDataGenerator:
    ...
    def __init__(self):
        ...
        self.ips = [
            "192.168.1.100", "192.168.1.101", "10.0.0.1", "10.0.0.5",
            "172.16.0.50", "172.16.0.100", "203.0.113.1", "198.51.100.42"
        ]
        self.user_agents = [
        ...
        self.paths = [
            "/", "/index.html", "/api/users", "/api/data", "/health",
            "/login", "/dashboard", "/static/css/style.css", "/favicon.ico"
        ]
    ...
    def apache_combined_logs(self, count: int = 50) -> List[str]:
        ...
        for i in range(count):
            ...
            status = random.choice([200, 200, 200, 201, 404, 500])  # Weighted toward success
    ...
    def json_application_logs(self, count: int = 40) -> List[str]:
        ...
        for i in range(count):
            ...
            if level == "ERROR":
                ...
                base_log.update({
                    "message": random.choice(["User login successful", "Request processed", "Cache updated"]),
